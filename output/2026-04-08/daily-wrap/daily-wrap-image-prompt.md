# Daily Wrap Card — ChatGPT / DALL-E Image Prompt
...
Top right corner, 28 pixels from top and 48 pixels from right: small sans-serif label "Daily Wrap" in dark muted gray, color #444, size 15pt, font weight 400. SF Pro Display or identical geometric grotesque throughout.

Center of the card, stacked vertically:

Row 1 — small day label. The word "WEDNESDAY" in ALL CAPS, dark muted gray color #555, size 24pt, weight 500, letter-spacing 3 pixels, centered. 8 pixels below the row-2 date.

Row 2 — the date. "April 8" in ultra-bold white sans-serif, 80pt, letter-spacing negative 3 pixels, color #FFFFFF, weight 800, centered. 44 pixels of space below before the next row.

Row 3 — the index readout. Horizontally centered, three elements on one baseline with 16 pixels of gap between each:
- "S&P 500" in muted gray #666, size 20pt, weight 400, letter-spacing 2 pixels
- "6,120" in white #FFFFFF, size 56pt, weight 700 (aligned to baseline with the label above)
- "-0.4%" in bright red #EF4444, size 32pt, weight 700

Row 4 — headline tagline. Positioned 24 pixels below the index row. Max width 800 pixels. Centered, line-height 1.5. Text: "Tech and chips led the sell-off ahead of tomorrow's CPI print." Color medium gray #999, size 22pt, weight 400.
...
Key color note for this variant: because the day closed down 0.4%, the percentage number "-0.4%" uses bright red #EF4444. If you regenerate for a green-day wrap, swap that color to bright emerald green #22C55E and keep everything else identical.
...
- If the date text wraps weirdly, add: "April 8 is on a single line, not wrapped."
