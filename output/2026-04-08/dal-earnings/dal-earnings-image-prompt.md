# DAL Earnings Card — ChatGPT / DALL-E Image Prompt
...
Top right corner, 28 pixels from top and 48 pixels from right: small sans-serif label "Q1 FY2026 Earnings" in dark muted gray, color #444, size 15pt, font weight 400. SF Pro Display or identical geometric grotesque throughout.

Center of the card, stacked vertically:

Row 1 — the ticker block. The three letters "DAL" in ultra-bold white sans-serif, 120pt, letter-spacing negative 4 pixels, color #FFFFFF, weight 800. Immediately to the right of "DAL" with 24 pixels of spacing, a horizontal pill badge. Pill dimensions roughly 120 by 48 pixels. Pill background rgba(34,197,94,0.15) (translucent green). Pill border 2 pixels solid, color #22C55E (bright emerald green). Pill border radius 6 pixels. Inside the pill, the word "BEAT" in ALL CAPS, color #22C55E, weight 700, size 24pt, letter-spacing 3 pixels, vertically centered.
...
- If the pill looks wrong, specify: "The BEAT pill is a rounded rectangle badge, not a circle or oval."
