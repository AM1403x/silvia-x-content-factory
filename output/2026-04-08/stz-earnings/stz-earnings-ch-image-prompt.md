...
His left hand is extended toward the monitor on his desk, index finger pointing. The monitor shows a chart with a distinct two-part shape: a sharp green spike upward on the left side of the screen (Q4 BEAT), then a clear red drop downward on the right side (FY27 GUIDE CUT). In the top corner of the screen, the plain letters "STZ" are visible.

On the near edge of the desk: a wine glass tipped over on its side, with a small red-wine puddle spreading across the desk surface. This represents Constellation's troubled wine and spirits portfolio. A few stray drops of wine frozen mid-fall.
...
- Tie color: DEEP BURGUNDY (wine country reference + mixed-feelings mood)
- Key props: Modelo beer bottle (held up proudly), spilled wine glass (wine portfolio trouble), monitor with split green/red chart (beat + guide cut)
- Mood: split feelings, half-smile half-frown
- Character expression: conflicted, one mouth corner up, one down, eyebrows raised
